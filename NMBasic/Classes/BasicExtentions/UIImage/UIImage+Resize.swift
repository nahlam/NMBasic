...
public extension UIImage {
    ...
    public class func nm_squareImageTo(image: UIImage, size: CGSize) -> UIImage {
        return nm_resizeImage(image: nm_squareImage(image: image), targetSize: size)
    }
    
    public class func nm_squareImage(image: UIImage) -> UIImage {
    ...
    public class func nm_resizeImage(image: UIImage, targetSize: CGSize) -> UIImage {
        let size = image.size
