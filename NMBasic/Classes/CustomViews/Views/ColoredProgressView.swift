...
open class ColoredProgressView: UIView   {
    ...
    private func getFirstView() -> UIView   {
        return getView(index: 0, viewPercentage: 0.0)
    }
    
    private func getSecondView() -> UIView   {
        return getView(index: 1, viewPercentage: 20.0)
    }
    
    private func getThirdView() -> UIView   {
        return getView(index: 2, viewPercentage: 40.0)
    }
    
    private func getForthView() -> UIView   {
        return getView(index: 3, viewPercentage: 60.0)
    }
    
    private func getFifthView() -> UIView   {
        return getView(index: 4, viewPercentage: 80.0)
    }
