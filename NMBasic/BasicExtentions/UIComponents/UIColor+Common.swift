...
extension UIColor   {
    ...
    open class var customVeryLightGrey: UIColor {
        return UIColor(red: 244.0 / 255, green: 244.0 / 255, blue: 244.0 / 255, alpha: 1.0)
    }
    
    open class var appBasic: UIColor {
        return NMBasicManager.shared.basicColor ?? UIColor.saleBasicColor
    }
    
    open class var saleBasicColor:UIColor   {
        return UIColor(red: 29.0 / 255, green: 175.0 / 255, blue: 236.0 / 255, alpha: 1.0)
    }
    
    open class var customRedColor: UIColor {
        return UIColor.red
    }
    ...
    open class var customOrangeColor50: UIColor {
        return UIColor(red: 255.0 / 255, green: 128.0 / 255, blue: 0.0 / 255, alpha: 0.5)
    }
    
    open class var customRedColor50: UIColor {
