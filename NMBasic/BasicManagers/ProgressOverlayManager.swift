...
open class ProgressOverlayManager: NSObject {
    ...
    open static let sharedInstance : ProgressOverlayManager = {
    ...
    open func updateProgress(_ percentage: Float) {
    ...
    open func updateProgressIndecator(_ percentage: Int) {
    ...
    open func showProgressIndecator(title: String) {
        DispatchQueue.main.async {
    ...
    open func showProgressIndecator() {
    ...
    open func showProgressIndecator(_ percentage: Float = 0.0, title: String = "") {
        DispatchQueue.main.async {
            self.progressView = MRProgressOverlayView()
